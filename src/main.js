...
function activityEditor(){
  ...
  return '<form id="activity-edit-form" class="activity-editor" data-form="activity" novalidate><div class="activity-edit-row"><label>Entrada</label><div class="activity-edit-fields"><input name="time" data-draft-activity type="time" value="'+esc(time)+'" aria-label="Horário"><input name="title" data-draft-activity value="'+esc(a.title||'')+'" placeholder="Texto da entrada" aria-label="Texto da entrada"></div></div></form>';
}
